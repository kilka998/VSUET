...
## Practical lesson 12
### Task 1.1
Ссылка на выполненное задание: [Практический урок 12_1](./Practical_lesson_12_1.py)
###
https://habr.com/ru/post/453444/, по последней цифре зачетки получить JSON
для вашего варианта.
Моя последняя цифра зачетки: 6
Репозиторий: https://github.com/firehol/blocklist-ipsets

### Task 1.2
Ссылка на выполненное задание: [Практический урок 12_2](./Practical_lesson_12_2.py)
###
...
## Practical lesson 3 sem 3
Ссылка на выполненное задание: [Практический урок 3 семестр 3](./Practical_lesson_3_sem_3.py)
Ссылка на вывод из консоли: [Вывод из консоли](./Practical_lesson_3_sem_3.txt)
Ссылка на диаграммы: [Диаграммы](./Practical_lesson_3_sem_3.png)
###
Теоретический материал
Теория для выполнения практической работы доступна в лекциях 4-6:
...
Делаем сверточную нейронную сеть в Keras
Примеры архитектур сверточных сетей VGG-16 и VGG-19
а также в соответствующих видеоматериалах, размещенных по ссылкам в
лекциях.
Задания на практическую работу
Для БД CIFAR-10 – полноцветных изображений реальных объектов создать
архитектуру сверточной НС с наименьшим числом нейронов, достаточных для
правильной классификации изображений тестовой выборки на уровне не
менее 92%. Обучить НС с контролем эффекта переобучения путем
использования выборки валидации. Дополнительно выполнить задания по
вариантам. Дополнительно выполнить задания по вариантам.

Дополнительное задание:
Добавить (или убрать, если они были в исходной сети) слои
Dropout и сравнить качество классификации до и после
внесенных изменений. Подобрать параметр слоя Dropout для
получения лучшей классификации тестовой выборки.
Объяснить полученные результаты.


## Practical lesson 4 sem 3
Ссылка на выполненное задание: [Практический урок 4 семестр 3](./Practical_lesson_4_sem_3.py)
Ссылка на вывод из консоли: [Вывод из консоли](./Practical_lesson_4_sem_3.txt)
Ссылка на диаграммы: [Диаграммы](./Practical_lesson_4_sem_3.png)
###
Основное задание
Для базы данных IMDB — текстовых отзывов на фильмы создать архитектуру рекуррентной
нейронной сети, достаточной для правильной классификации тестовой выборки на уровне не
менее 85%. Обучить НС с контролем эффекта переобучения путем использования выборки
валидации.
Дополнительное задание
Добавить слои Dropout и/или recurrent_dropout в LSTM-слои и сравнить качество
классификации до и после внесенных изменений. Подобрать оптимальный
параметр Dropout для предотвращения переобучения.
